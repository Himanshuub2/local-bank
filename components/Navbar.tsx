    ...
    return (
        <div > 
            <header className = "h-content w-screen  border-4 border-orange-500 bg-[#FFFAF0]" >
                <div className = "flex ">
                    <Image src = {logo} className = "w-[206px] h-[180px] ml-40 my-[8px]" alt = "company_logo " ></Image>
                ...
                <table className = "w-screen">
                    <tbody >
                        <tr className = "flex justify-evenly items-center h-[84px] [&>*]:w-[100px] [&>*]:items-center [&>*]:text-white  text-[18px] font-medium">
                            <td className = "ml-[160px] hover:bg-[#adff2f] hover:py-[24px] hover:cursor-pointer text-center"><Link href="/home" className ="px-[10px] py-[15px]">Home</Link></td>
